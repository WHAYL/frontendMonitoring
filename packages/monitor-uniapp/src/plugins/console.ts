...
import type { UniAppMonitorPlugin, UniAppMonitorPluginInitArg, ConsoleExtraData, ConsolePluginConfig } from '../type';
import { LogCategoryKeyValue } from '@whayl/monitor-core';

export class ConsolePlugin implements UniAppMonitorPlugin {
    name = 'console';
