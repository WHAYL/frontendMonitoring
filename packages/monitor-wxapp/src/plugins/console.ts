...
import type { WxAppMonitorPlugin, WxAppMonitorPluginInitArg, ConsoleExtraData, ConsolePluginConfig } from '../type';
import { LogCategoryKeyValue } from '@whayl/monitor-core';

export class ConsolePlugin implements WxAppMonitorPlugin {
    name = 'console';
