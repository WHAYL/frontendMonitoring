(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.AiyMonitorWxapp = factory());
    ...
    ***************************************************************************** */
    ...
    var RequestPlugin = (function () {
        ...
        RequestPlugin.prototype.rewriteHttpRequest = function () {
            try {
                var originalRequest_1 = wx.request;
                var self_1 = this;
                wx.request = function (param) {
    ...
    var WxAppMonitor = (function () {
        ...
        WxAppMonitor.prototype.diyReportInfo = function (type, data) {
            this.reportInfo(type, __assign$1(__assign$1({}, data), { pluginName: 'WxAppDiyReportInfo', url: getWxCurrentPages().page, timestamp: getTimestamp(), date: formatTimestamp() }));
        };
